...
public class Track implements Serializable {
    ...
    private ArrayList<Sendout> sentTo;

    private int currentVersion;
    private ArrayList<TrackVersion> fileHistory;

    public Track(String filePath, String previewFolder, String name, String notes, LocalDate deadline, TrackStage stage, String projectPath, String projectFolder, boolean onDropbox, boolean projectLost, ArrayList<Tag> tags, int rating, ArrayList<Sendout> sentTo, int currentVersion, ArrayList<TrackVersion> fileHistory, boolean done) {
    ...
    public ArrayList<Sendout> getSentTo() {
        if (sentTo != null) {
            return sentTo;
        }
        return new ArrayList<Sendout>();
    }

    public void setSentTo(ArrayList<Sendout> sentTo) {
        this.sentTo = sentTo;
    }
    ...
    public ArrayList<TrackVersion> getFileHistory() {
        if (fileHistory != null) {
            return fileHistory;
        }
        return new ArrayList<TrackVersion>();
    }

    public void setFileHistory(ArrayList<TrackVersion> fileHistory) {
        this.fileHistory = fileHistory;
    }
