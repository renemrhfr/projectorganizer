...
public class FirstRunAlertBox {
    ...
    userTextField.setPromptText("Dossa, Locuzzed or someone else?");
    ...
    saveButton.setOnAction(e -> {
        if (!"".equals(userTextField.getText() ) && !"".equals(pathTextField.getText())) {
            ...
            settings.setContactsFilename(settings.getDropboxRoot() + File.separator + "ProjectOrganizer" + File.separator + settings.getContactsFilename());
            settings.setTagsFilename(settings.getDropboxRoot() + File.separator + "ProjectOrganizer" + File.separator + settings.getTagsFilename());
            settings.setTracksFilename(settings.getDropboxRoot() + File.separator + "ProjectOrganizer" + File.separator + settings.getTracksFilename());
            fileHandler.rewriteFile(settings.getSettingsFilename(), Settings.class, settings);
    ...
    private static void createInitTags() {
        ArrayList<Tag> initTags = MockData.mockTags();
