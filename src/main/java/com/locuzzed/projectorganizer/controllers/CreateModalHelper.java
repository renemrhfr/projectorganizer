...
public class CreateModalHelper {
    ...
    public void createEditModal(ApplicationController controller, Track track) {
        ...
        modalController.modalCancelButton.setOnAction(e -> {
            modal.close();
        });
    ...
    public void createVersionModal(ApplicationController controller, Track track) {
        ...
        modalController.newVersionModalSaveButton.setOnAction(e -> {
            track.setCurrentVersion(parseInt(modalController.newVersionModalVersionTextfield.getText().toString()));
        ...
        modalScene.setOnDragOver(new EventHandler<>() {
            @Override
    ...
    public void createRestrictedVersionModal(Track track) {
    ...
    public void createContactModal() {
        ...
        modalController.contactModalClose.setOnAction(e -> {
            modal.close();
        });
    }
