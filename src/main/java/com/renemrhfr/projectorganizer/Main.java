...
import com.renemrhfr.projectorganizer.controllers.ApplicationController;
...
public class Main extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        ApplicationController mainController = applicationLoader.getController();
    ...
    public static void readFiles() {
        ...
        if (settingsFile.exists()) {
            List<Settings> savedSettings = fileHandler.readFile(settings.getSettingsFilename(), Settings.class);
        ...
        if (contacts.exists()) {
            List<Contact> savedContacts = fileHandler.readFile(settings.getContactsFilename(), Contact.class);
        ...
        if (tags.exists()) {
            List<Tag> savedTags = fileHandler.readFile(settings.getTagsFilename(), Tag.class);
        ...
        if (tracks.exists()) {
            List<Track> savedTracks = fileHandler.readFile(settings.getTracksFilename(), Track.class);
            if (savedTracks != null) {
