...
public class EditTrackController {
    ...
    public void initHandlers() {
        ...
        modalSendoutListView.getSelectionModel().selectedItemProperty().addListener(e -> modalRemoveSendoutButton.setDisable(false));
    ...
    public void fillUI(Track track) {
        ...
        modalContactChoiceBox.getItems().addAll(dataStore.getContacts()
                ...
                .sorted()
                .toList());
        if (!modalContactChoiceBox.getItems().isEmpty()) {
        ...
        // Button
        modalSendoutButton.setOnAction(e -> addSendout(track, modalContactChoiceBox.getValue().toString(),modalVersionChoiceBox.getValue() != null ? modalVersionChoiceBox.getValue().toString() : null));
    }
    ...
    public void save(Track track) {
        ...
        List<Sendout> sent = track.getSentTo();
